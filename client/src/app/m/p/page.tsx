        ...
        <div className="relative w-full min-h-screen overflow-hidden" style={{ background: "#010b14" }}>
            ...
            <div
                style={{
                    ...
                    pointerEvents: "none",
                    background:
                        "radial-gradient(ellipse at 50% 40%, transparent 30%, rgba(1,11,20,0.55) 100%)",
                }}
            />
            ...
            >
                ...
                {/* Subtitle */}
                <p
                    className="max-w-sm text-base leading-relaxed mb-10"
                    style={{
                        color: "rgba(187,247,208,0.6)",
                        fontStyle: "italic",
                    }}
                >
                    Solar wind meets atmosphere — nature&apos;s own light show, painted across the Arctic sky.
                </p>

                {/* CTA buttons */}
                <div className="flex flex-wrap gap-3 justify-center">
                    <button
                        className="text-xs uppercase tracking-[0.2em] px-7 py-3 rounded-sm cursor-pointer transition-all hover:scale-105"
                        style={{
                ...
                >
                    {[
                        { value: "KP 7", label: "Activity", color: "#4ade80" },
                        { value: "−18°C", label: "Temp", color: "#22d3ee" },
                        { value: "02:14", label: "Local time", color: "#818cf8" },
                    ].map((stat) => (
